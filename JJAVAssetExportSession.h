...
@protocol JJAVAssetExportSessionDelegate;


/**
 * An `JJAVAssetExportSession` object transcodes the contents of an AVAsset source object to create an output
...
@property (nonatomic, weak) id<JJAVAssetExportSessionDelegate> delegate;
...
@protocol JJAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(JJAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
